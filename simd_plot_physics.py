...
# Pretty labels
name_map = {
    "pthread_mutex_simd_blocked": "Pthread Mutex Simd Blocked",
    "pthread_mutex_simd_interleaved": "Pthread Mutex Simd Interleaved",
    "pthread_simd_blocked": "Pthread Simd Blocked",
    "pthread_simd_interleaved": "Pthread Simd Interleaved",
